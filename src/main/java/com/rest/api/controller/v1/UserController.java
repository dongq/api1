...
public class UserController {
    ...
    public SingleResult<User> findUserById(@ApiParam(value = "회원ID", required = true) @PathVariable String userId
                                          ,@ApiParam(value = "언어", defaultValue = "ko") @RequestParam String lang ) throws Exception{
        return responseService.getSingleResult(userJpaRepo.findByUid(userId).orElseThrow(CUserNotFoundException::new));
    }
